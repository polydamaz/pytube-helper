...
if d.yesno("Are you REALLY sure you want to see this?") == d.OK:
    ...
    code, [tags, kbd = d.checklist("What sandwich toppings do you like?",
                             choices=[("Catsup", "test01",             False),
                                      ("Mustard", "test02",            False),
                                      ("Pesto", "test03",              False),
                                      ("Mayonnaise", "test04",         True),
                                      ("Horse radish","test05",        True),
                                      ("Sun-dried tomatoes", "test06", True)],
